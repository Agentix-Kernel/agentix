...
class HubleProvider(Provider):
    """Route LlmRequest → HUBLE /api/v2/agent/chat → LlmResponse.
...
def _parse_huble_response(body: dict[str, Any], model: str) -> LlmResponse:
    """Translate HUBLE's response body to the canonical ``LlmResponse``.
