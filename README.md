...
| `docs/` | Cluster architecture, contracts consumer guide, proposals, + config/policy docs (network, env-and-secrets, tooling, db, docker, domains, email, integrations, licensing, logging) |
